 ...
 * @author Max
 */
public class IUVentasPorModelo extends javax.swing.JFrame {

    /**
     * Creates new form IUVentasPorModelo
     */
    Conexion conexion;
    public IUVentasPorModelo() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IUVentasPorModelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run(){
                new IUVentasPorModelo().setVisible(true);
            }
        });
    }
    ...
    private void llenarComboboxModelo() {
        ResultSet rs = null;       
        try {
           rs = conexion.resultado("SELECT \"getModelos\"();");
           boolean r = rs.next();
           while( r ){
